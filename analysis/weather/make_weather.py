...
'''Erstellt aus einer Dymola Wetterdatei eine ebenbürtige Datei für den Versuchsstand'''

# Dateipfade
input_file = "weather/DEU_Berlin.103840_IWEC.mos"
output_file = "weather/DEU_Berlin.103840_IWEC.csv"
...
with open(output_file, mode='w', newline='') as csvfile:
    ...
    for i in range(len(data) - 1):
        ...
        for t, temp, humidity in zip(times, temps, humidities):
            ...
            writer.writerow([time_str, f"{temp:.1f}", f"{humidity:.1f}", "True", "True", "fall"])
